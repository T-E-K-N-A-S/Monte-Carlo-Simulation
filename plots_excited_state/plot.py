...
csv_path = '/home/shikhar/Documents/sanket/Monte-Carlo-Simulation/excited_spins'
file_list =  os.listdir(csv_path)
file_list = [e for e in file_list if e.endswith('.csv')] 
...
for each_file in file_list:
    ...
    img_name = each_file.split('.')[0] +  '.' + each_file.split('.')[1]   + ' plot.png'
